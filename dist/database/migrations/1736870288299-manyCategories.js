...
exports.manyCategories1736870288299 = void 0;
class manyCategories1736870288299 {
    constructor() {
        this.name = 'manyCategories1736870288299';
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE "category" DROP CONSTRAINT "FK_bc46ece019a59318bf23f4c6e2e"`);
        await queryRunner.query(`ALTER TABLE "category" DROP COLUMN "torneoId"`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "pais"."updatedAt" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "pais"."createdAt" IS NULL`);
        await queryRunner.query(`ALTER TABLE "category" ADD "torneoId" integer`);
...
exports.manyCategories1736870288299 = manyCategories1736870288299;
//# sourceMappingURL=1736870288299-manyCategories.js.map