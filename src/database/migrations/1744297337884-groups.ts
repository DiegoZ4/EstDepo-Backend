...
export class groups1744297337884 implements MigrationInterface {
    name = 'groups1744297337884'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "partido" ADD "group" character varying(255)`);
        await queryRunner.query(`ALTER TABLE "torneo" ADD "groups" text`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`COMMENT ON COLUMN "pais"."updatedAt" IS NULL`);
        await queryRunner.query(`COMMENT ON COLUMN "pais"."createdAt" IS NULL`);
        await queryRunner.query(`ALTER TABLE "torneo" DROP COLUMN "groups"`);
        await queryRunner.query(`ALTER TABLE "partido" DROP COLUMN "group"`);
    }
