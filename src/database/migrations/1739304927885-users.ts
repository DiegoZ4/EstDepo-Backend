...
export class users1739304927885 implements MigrationInterface {
    name = 'users1739304927885'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "users_rol_enum" AS ENUM('freeUser', 'SubsUser', 'admin')`);
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "nombre" character varying NOT NULL, "contraseña" character varying NOT NULL, "rol" "users_rol_enum" NOT NULL DEFAULT 'freeUser', "nacimiento" date, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
